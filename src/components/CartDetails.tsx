import { removeProduct, updateQuantity } from "@/redux/featuers/cartSlice";
...
const CartDetails = ({ product }: any) => {
  ...
  return (
    <div className="flex items-center justify-between space-x-4 border border-gray-300 rounded-lg p-4 bg-white shadow-md transition-transform transform hover:scale-105 hover:shadow-lg w-full max-w-md mx-auto mt-6">
      <img
        src={product.image}
        alt={product.name}
