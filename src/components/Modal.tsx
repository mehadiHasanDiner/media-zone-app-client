...
const Modal = ({ product, onClose, handleAddToCart }: any) => {
  console.log(product);
  return (
    <div className="bg-black/60 backdrop-blur-sm fixed top-0 left-0 w-screen h-screen z-50 ">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-lg rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          ...
          <div className="p-5 lg:p-11">
            ...
            <p className="text-sm lg:text-base mb-2 lg:mb-16 font-semibold mt-3 text-gray-800">
              {product?.seller ? product?.seller : "No seller found"}
            </p>
